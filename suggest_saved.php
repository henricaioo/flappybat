...
<body>
  <header>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <li><a class="dropdown-item" href="save_suggest.html">Sugestões salvas</a></li>
                </ul>
              </li>
            </ul>
    ...
    <div id="avaliacao" class="container">
        <div>
            <h3 class="my-5">Sugestões salvas</h3>
        </div>
                ...
                while($dados = mysqli_fetch_assoc($res)){
                    echo "<div class='sug'>
                            <div class='user'>
                                ...
                                <p>". $dados['username'] ."</p>
                                <a class='btn btn-danger m-2' href='delete_suggest.php?cod=". $dados["id_sugestao"] ."'>
                                    Excluir
                                </a>
                            </div>
                            <div>
