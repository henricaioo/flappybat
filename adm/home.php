            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item">
                    <a class="nav-link text-white" href="icones.html">icones</a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                      <li><a class="dropdown-item" href="avaliar.html">avaliar sugestões</a></li>
                      <li><a class="dropdown-item" href="salvos.html">sugestões salvas</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
